...
public class SkuaConfigurationServer
{
    ...
    private SkuaClusteredService service;
    private ClusteredMediaDriver clusteredMediaDriver;
    private ClusteredServiceContainer container;
    private final Logger log = LoggerFactory.getLogger(SkuaClusteredService.class);

    public SkuaConfigurationServer(ShutdownSignalBarrier barrier)
    {
    ...
    public void start(final boolean deleteOnStart)
    {
        ...
        service = new SkuaClusteredService();
